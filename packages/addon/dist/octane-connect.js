import { defineProperty, get, notifyPropertyChange } from '@ember/object';
...
function octaneConnect(stateToComputed, dispatchToActions, WrappedComponent) {
  ...
  return class Connect extends WrappedComponent {
    constructor() {
      ...
      if (typeof dispatchToActions === 'object') {
        this.actions = Object.assign({}, this.actions, bindActionCreators(dispatchToActions, redux.dispatch.bind(redux)));
      }
    }
    willDestroy() {
      if (this.unsubscribe) {
...
export { octaneConnect as default };
//# sourceMappingURL=octane-connect.js.map
